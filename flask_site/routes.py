...
from flask_site import app, db, bcrypt, mail
from flask_site.forms import (RegistrationForm, LoginForm, UpdateAccountForm, PostForm,
...
def user_posts(username):
    ...
    return render_template('user_posts.html', title=user.username + "'s posts", posts=posts, user=user)


# send email
def send_reset_email(user):
    token = user.get_reset_token()
    msg = Message('Password Reset Request',   # subject line for sending email first
                  sender='noreply@demo.com',  # sender
