...
from flask_site.projects.face_privacy.utils import save_face_picture, remove_face_images
...
def face_privacy():
    ...
    if form.validate_on_submit():
        if form.picture.data:  # blur the input picture if it has a face
            ...
            imgs_path = (os.path.join(current_app.root_path, 'static/face_image/'))
            save_path = imgs_path
            ...
            yolo_face_detection(imgs_path, yolo_model, yolo_weights, yolo_classes, save_path)
            ...
            scaling = 1.1
            size = 10
            haar_face_detection(imgs_path, xmlPath, scaling, size, save_path)
